...
${PREFIX}/bin/dist:  $(GOFILES)
	@echo "+ $@"
	@go build -tags "${DOCKER_BUILDTAGS}" -o $@ ${GO_LDFLAGS}  ${GO_GCFLAGS} ./cmd/dist
...
binaries: ${PREFIX}/bin/registry ${PREFIX}/bin/digest ${PREFIX}/bin/dist ${PREFIX}/bin/registry-api-descriptor-template
	@echo "+ $@"
